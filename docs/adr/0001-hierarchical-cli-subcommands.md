...
treesitter-ls started with flat CLI commands:

```
treesitter-ls install <language>
...
treesitter-ls language uninstall <lang>
...
- **Discoverability**: `treesitter-ls language --help` shows all language-related commands

...
4. **Per-Request Timeout** (ADR-0015): Bounds user-facing latency for multi-server aggregation *[Phase 3 only]*
...
- **[ADR-0013](0013-async-bridge-connection.md)**: Defines idle and initialization timeouts
- **[ADR-0014](0014-actor-based-message-ordering.md)**: Connection state machine (state-based timeout gating)
- **[ADR-0015](0015-multi-server-coordination.md)**: Per-request timeout *(Phase 3)*
- **[ADR-0016](0016-graceful-shutdown.md)**: Global shutdown timeout

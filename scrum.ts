...
const scrum: ScrumDashboard = {
  ...
  completed: [
    ...
    { number: 12, pbi_id: "pbi-connection-states", goal: "Add Closing and Closed states with valid transitions and operation gating", status: "done", subtasks: [
      { test: "Unit test: ConnectionState enum has all 5 variants (Initializing, Ready, Failed, Closing, Closed)", implementation: "Add Closing and Closed variants to ConnectionState enum in pool.rs", type: "behavioral", status: "completed", commits: [{ hash: "57e5445e", message: "feat(pool): add Closing and Closed variants to ConnectionState enum", phase: "green" }], notes: [] },
      { test: "Unit test: Ready state + shutdown signal = Closing state (valid transition)", implementation: "Update set_state() to allow Ready -> Closing transition", type: "behavioral", status: "completed", commits: [{ hash: "0e0a0c65", message: "feat(pool): add try_transition with state machine validation", phase: "green" }], notes: [] },
      { test: "Unit test: Initializing state + shutdown signal = Closing state (valid transition)", implementation: "Update set_state() to allow Initializing -> Closing transition", type: "behavioral", status: "completed", commits: [{ hash: "32bf333a", message: "test(pool): add test for Initializing -> Closing transition", phase: "green" }], notes: ["Implementation was already done in try_transition from subtask 2"] },
      { test: "Unit test: Closing state completes to Closed (valid transition)", implementation: "Update set_state() to allow Closing -> Closed transition", type: "behavioral", status: "completed", commits: [{ hash: "191f16c9", message: "test(pool): add test for Closing -> Closed transition", phase: "green" }], notes: ["Implementation was already done in try_transition from subtask 2"] },
      { test: "Unit test: Failed state transitions directly to Closed, bypassing Closing", implementation: "Update set_state() to allow Failed -> Closed transition (direct, no LSP handshake)", type: "behavioral", status: "completed", commits: [{ hash: "7ee0cab9", message: "test(pool): add tests for Failed -> Closed transition", phase: "green" }], notes: ["Implementation was already done in try_transition from subtask 2", "Also added test for invalid Failed -> Closing transition"] },
      { test: "Unit test: new requests in Closing state receive REQUEST_FAILED error", implementation: "Add operation gating for Closing state in request handling that rejects with REQUEST_FAILED", type: "behavioral", status: "completed", commits: [{ hash: "76e3073d", message: "test(pool): add test for operation gating during Closing state", phase: "green" }], notes: ["Implementation was already done in subtask 1 when Closing arm was added to the match statement", "Error message is 'bridge: connection closing' (io::Error::other)"] },
    ] },
  ],
  definition_of_done: {
    checks: [

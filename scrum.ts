  ...
  sprint: {
    ...
    subtasks: [
      ...
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Key change: separate connection spawning from initialization waiting"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["ADR-0015: Initializing -> Ready on success"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["ADR-0018: Init timeout 30-60s; ADR-0015: Initializing -> Failed on timeout/failure"],
      },
      {

  ...
  sprint: {
    ...
    subtasks: [
      ...
      },
      {
        ...
        status: "red",
        commits: [],
        notes: ["AC1: Validates partial identifier completion", "Infrastructure working (no errors), lua-ls returns null - needs workspace/rootUri config investigation", "Changed virtual URI to file:///.treesitter-ls/ format with .lua extension for compatibility"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["AC2: Validates table member completion", "Depends on lua-ls returning actual completions"],
      },
    ],
  },

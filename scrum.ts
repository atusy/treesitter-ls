  ...
  sprint: {
    ...
    subtasks: [
      ...
      // Subtask 9 (structural): Monitor bridge.rs size per Sprint 144 retrospective
      {
        ...
        implementation: "Split bridge.rs (was 1145 lines) into submodules: connection.rs (176), protocol.rs (277), manager.rs (171), bridge.rs (564 with tests)",
        type: "structural",
        status: "completed",
        commits: [],
        notes: ["Sprint 144 retrospective action; split into 4 files, each under 600 lines"],
      },
    ],
  },

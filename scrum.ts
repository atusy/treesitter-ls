  ...
  sprint: {
    ...
    subtasks: [
      ...
      },
      {
        ...
        implementation: "Create find_injection_at_position helper that returns InjectionRegionInfo for a byte offset",
        type: "behavioral",
        status: "pending",
        commits: [],
        notes: ["Used by hover.rs and completion.rs to find target injection", "Input: byte offset, list of injections", "Output: Option<&InjectionRegionInfo>"],
      },
      {

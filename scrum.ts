  ...
  sprint: {
    ...
    subtasks: [
      ...
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Protocol helper for constructing didClose notifications"],
      },
      {
      ...
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Full integration from Neovim to downstream server"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Critical: connection lifecycle is independent of document lifecycle"],
      },
    ],
  },
  completed: [

    ...
    subtasks: [
      {
        ...
        type: "behavioral",
        status: "completed",
        commits: [{ hash: "e87f9f79", message: "feat(bridge): add signature help request/response protocol functions", phase: "green" }],
      ...
      },
      {
        ...
        type: "behavioral",
        status: "completed",
        commits: [{ hash: "65d8eb5f", message: "feat(bridge): add send_signature_help_request to LanguageServerPool", phase: "green" }],
      ...
      },
      {
        ...
        type: "behavioral",
        status: "completed",
        commits: [{ hash: "338b0740", message: "feat(lsp): delegate signature_help to bridge for injection regions", phase: "green" }],

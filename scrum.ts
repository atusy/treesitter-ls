    ...
    subtasks: [
      {
        ...
        status: "green",
        commits: [],
        notes: ["Data structure foundation for tracking host→virtual mappings", "Tests pass but clippy warns about dead code - need Subtask 2 to use the fields"],
      },
      {
        ...
        status: "green",
        commits: [],
        notes: ["Maps host document to its virtual documents for later cleanup", "Tests pass; clippy warns about unused fields - will be fixed in Subtask 5"],
      },
      {
        ...
        status: "completed",
        commits: [],
        notes: ["Protocol helper not needed - send_didclose_notification builds notification inline from virtual_uri directly", "Removed unused function to pass clippy"],
      },
      {

  ...
  sprint: {
    ...
    subtasks: [
      ...
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Cross-region references cannot be resolved, must be filtered"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Real file URIs are already valid; parts without location need no transformation"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Wires up the new context parameter at the call site"],
      },
    ],
  },
  completed: [

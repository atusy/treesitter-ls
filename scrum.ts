  ...
  sprint: {
    ...
    subtasks: [
      ...
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["ADR-0015 state machine diagram"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["ADR-0017: abort initialization, proceed to shutdown"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Terminal state for graceful shutdown path"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["ADR-0017: stdin unavailable in Failed state"],
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["Error message: 'bridge: connection closing'", "Update did_change.rs and did_close.rs state checks"],
      },
      ...
      },
      {
        ...
        status: "pending",
        commits: [],
        notes: ["End-to-end shutdown sequence with pending requests"],
      },
    ],
  },
  completed: [

...
9. **E2E: Partial Identifier Completion** (Subtask 9)
   ...
   - Notes: Changed virtual URI to `file:///.kakehashi/{hash}/{id}.lua` for compatibility
...
- Old: Custom scheme (e.g., `kakehashi://virtual/...`)
- New: `file:///.kakehashi/{hash}/{id}.lua` (lua-ls compatible)
...
**Hypotheses:**
1. **Virtual URI not recognized** - lua-ls may not accept `file:///.kakehashi/` scheme
...
- Clear separation of concerns (kakehashi vs lua-ls)
...
**Core Implementation:**
- `/Users/atusy/ghq/github.com/atusy/kakehashi___async-bridge/src/lsp/bridge/protocol.rs` (536 lines added)
- `/Users/atusy/ghq/github.com/atusy/kakehashi___async-bridge/src/lsp/bridge/manager.rs` (347 lines added)
- `/Users/atusy/ghq/github.com/atusy/kakehashi___async-bridge/src/lsp/lsp_impl/text_document/completion.rs` (173 lines modified)

**E2E Testing:**
- `/Users/atusy/ghq/github.com/atusy/kakehashi___async-bridge/tests/e2e_lsp_lua_completion.rs` (219 lines)
- `/Users/atusy/ghq/github.com/atusy/kakehashi___async-bridge/tests/helpers/lsp_client.rs` (305 lines)
- `/Users/atusy/ghq/github.com/atusy/kakehashi___async-bridge/tests/helpers/lsp_polling.rs` (64 lines)

**Dashboard:**
- `/Users/atusy/ghq/github.com/atusy/kakehashi___async-bridge/scrum.ts` (337 lines)

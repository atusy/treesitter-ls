...
fn test_basic_compilation() {
    ...
    let scope_patterns = vec![
        "block", "function_item", "if_expression", "while_expression", 
        "for_expression", "closure_expression", "match_expression"
    ];
    ...
    for pattern in scope_patterns {
        ...
        ), "Pattern {} should be recognized as scope", pattern);
    }
...
fn test_context_type_enum() {
    use treesitter_ls::definition_resolution::ContextType;

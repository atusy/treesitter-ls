...
mod definition_jumping_behavior {
    ...
    fn should_find_function_definition() {
        ...
        let reference_position = Position { line: 10, character: 15 };
    ...
    fn should_find_variable_definition() {
        ...
        // Variable usage
        let reference_position = Position { line: 5, character: 12 };
    ...
    fn should_prefer_local_scope_definitions() {
        ...
        let reference_position = Position { line: 7, character: 10 };
...
mod configuration_behavior {
    ...
    fn should_map_file_extensions_to_languages() {
        ...
        filetypes.insert("rust".to_string(), vec!["rs".to_string(), "rust".to_string()]);
        filetypes.insert("python".to_string(), vec!["py".to_string(), "pyi".to_string()]);
...
mod performance_behavior {
    ...
    fn should_handle_large_files_efficiently() {
        ...
        for i in 0..symbol_count {
            let symbol = SymbolDefinition {
                ...
                range: Range {
                    ...
                    end: Position { line: i as u32, character: 15 },
                },
                kind: SymbolKind::FUNCTION,
            };
            symbols.push(symbol);
        ...
        assert!(creation_time.as_millis() < 1000, "Symbol creation took too long: {:?}", creation_time);
        ...
        assert!(search_time.as_millis() < 100, "Symbol search took too long: {:?}", search_time);
    }
    ...
    fn should_handle_frequent_updates() {
        ...
        for i in 0..update_count {
            let symbol = SymbolDefinition {
                ...
                range: Range {
                    start: Position { line: i as u32, character: 0 },
                    end: Position { line: i as u32, character: 20 },
                },
                kind: SymbolKind::VARIABLE,
            };
        ...
        assert!(update_time.as_millis() < 500, "Updates took too long: {:?}", update_time);
    }
}
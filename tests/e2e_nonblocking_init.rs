...
//!
//! These tests verify that treesitter-ls responds quickly even when
...
//! - AC1: treesitter-ls responds without blocking during lua-ls startup
...
///
/// This test verifies that treesitter-ls native features like selection range

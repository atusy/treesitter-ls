...
use super::super::protocol::{
    VirtualDocumentUri, build_bridge_didopen_notification, build_bridge_inlay_hint_request,
...
impl LanguageServerPool {
    ...
    pub(crate) async fn send_inlay_hint_request(
        ...
        // Build and send inlay hint request using upstream ID (ADR-0016)
        ...
        loop {
                ...
                && id.as_i64() == Some(request_id)
            {
                ...
                return Ok(transform_inlay_hint_response_to_host(msg, region_start_line));
            }

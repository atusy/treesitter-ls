...
use super::super::protocol::{
    VirtualDocumentUri, build_bridge_definition_request, transform_definition_response_to_host,
};
...
impl LanguageServerPool {
    ...
    pub(crate) async fn send_definition_request(
        ...
        conn.write_message(&definition_request).await?;

        // Wait for the definition response (skip notifications)
        loop {

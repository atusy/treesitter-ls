...
impl LanguageServer for TreeSitterLs {
    ...
    async fn selection_range(
        ...
        TreeSitterLs::selection_range(self, params).await
    }

    async fn code_action(&self, params: CodeActionParams) -> Result<Option<CodeActionResponse>> {
        TreeSitterLs::code_action(self, params).await
    }
    ...
    async fn signature_help(&self, params: SignatureHelpParams) -> Result<Option<SignatureHelp>> {
        TreeSitterLs::signature_help(self, params).await
    }

    async fn references(&self, params: ReferenceParams) -> Result<Option<Vec<Location>>> {
        TreeSitterLs::references(self, params).await
    }

    async fn rename(&self, params: RenameParams) -> Result<Option<WorkspaceEdit>> {
        TreeSitterLs::rename(self, params).await
    }

    async fn formatting(&self, params: DocumentFormattingParams) -> Result<Option<Vec<TextEdit>>> {
        TreeSitterLs::formatting(self, params).await
    }
}

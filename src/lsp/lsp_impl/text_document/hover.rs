//! Hover handler for textDocument/hover requests.
//!
//! This module contains the implementation of the hover method for TreeSitterLs,
//! which provides hover information for injection regions via bridge language servers.

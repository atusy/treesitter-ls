//! Signature help handler for textDocument/signatureHelp requests.
//!
//! This module contains the implementation of the signature_help method for TreeSitterLs,
//! which provides function signature information for injection regions via bridge
//! language servers.

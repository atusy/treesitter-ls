//! Formatting handler for textDocument/formatting requests.
//!
//! This module contains the implementation of the formatting method for TreeSitterLs,
//! which provides formatting functionality for injection regions via bridge language servers.

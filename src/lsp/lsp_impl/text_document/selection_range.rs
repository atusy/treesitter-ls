//! Selection range handler for textDocument/selectionRange requests.
//!
//! This module contains the implementation of the selection_range method for TreeSitterLs,
//! which provides syntax-aware selection expansion based on the AST structure.

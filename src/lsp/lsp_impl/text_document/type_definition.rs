...
impl TreeSitterLs {
    pub(crate) async fn goto_type_definition_impl(
        ...
        let result = tokio::task::spawn_blocking(move || {
            ...
            // Request type definition with notifications capture
            let result =
                conn.type_definition_with_notifications(&virtual_uri_clone, virtual_position);
        ...
        let (type_definition, notifications) = match result {
            Ok((result, conn)) => {

//! Semantic tokens handlers for textDocument/semanticTokens/* requests.
//!
//! This module contains the implementation of semantic tokens methods for TreeSitterLs:
//! - `semantic_tokens_full` - Full document semantic tokens
//! - `semantic_tokens_full_delta` - Delta semantic tokens
//! - `semantic_tokens_range` - Range-based semantic tokens

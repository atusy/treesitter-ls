    ...
    pub(crate) async fn folding_range_impl(
        ...
        for region in &injections {
            ...
            let result = tokio::task::spawn_blocking(move || {
                ...
                // Request folding ranges with notifications capture
                let result = conn.folding_range_with_notifications(&virtual_uri_clone);
            ...
            let (ranges, notifications) = match result {
                Ok((result, conn)) => {

...
mod tests {
    ...
    fn test_progress_token_format() {
        ...
        // Token should be a string with the format kakehashi/install/{language}
        match token {
            NumberOrString::String(s) => {
                assert_eq!(s, "kakehashi/install/python");
            }

...
mod tests {
    ...
    /// Uses TREESITTER_GRAMMARS env var if set (Nix), otherwise falls back to deps/tree-sitter.
    fn test_search_path() -> String {
        std::env::var("TREESITTER_GRAMMARS").unwrap_or_else(|_| "deps/tree-sitter".to_string())
    }
